namespace BLE_Hockey.Uuids
{
    public class HockeyTargetUuids
    {
        ...
        //public static Guid HockeyTargetServiceUuid { get; private set; } = new Guid("0000180a-0000-1000-8000-00805f9b34fb");

        //public static Guid HockeyTargetCharacteristicUuid { get; private set; } = new Guid("00002a00-0000-1000-8000-00805f9b34fb");
    }
}
